        ...
        variants: {
            variant: {
                ...
                filled: [
                    'bg-muted',
                    'border-subtle',
                    'enabled:[&:hover:not(.open)]:bg-muted-hover',
                    'enabled:[&:hover:not(.open)]:border-muted',
                ],
            },
            size: {
            ...
            open: {
                true: ['open', 'border-brand', 'z-1', 'ring-focused'],
                false: '',
            },
        },
        compoundVariants: [
...
const portalContent = cva<object>(['nd-select-portal-content', 'p-0', 'overflow-hidden']);
